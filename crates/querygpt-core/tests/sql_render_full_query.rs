...
use querygpt_core::dsl::plan::{
    IntermediatePlan, JoinCondition, JoinType, PlanJoin, PlanOrder, PlanProjection, PlanTable,
    SortDirection,
};
...
fn full_query_with_group_by_and_order_by() {
    let plan = IntermediatePlan {
        ...
        tables: vec![
            PlanTable {
                name: "offers_latest".into(),
                alias: "o".into(),
            },
            PlanTable {
                name: "offer_products".into(),
                alias: "opr".into(),
            },
        ],
        joins: vec![PlanJoin {
            ...
            conditions: vec![
                JoinCondition {
                    left_field: "o.id".into(),
                    right_field: "opr.offer_id".into(),
                },
                JoinCondition {
                    left_field: "o.profile".into(),
                    right_field: "opr.profile".into(),
                },
                JoinCondition {
                    left_field: "o.version".into(),
                    right_field: "opr.version".into(),
                },
            ],
        }],
        projections: vec![
