use querygpt_core::dsl::plan::{IntermediatePlan, JoinCondition, JoinType, PlanJoin, PlanTable};
...
fn renderer_is_deterministic_given_same_plan() {
        ...
        joins: vec![PlanJoin {
            ...
            conditions: vec![
                JoinCondition {
                    ...
                    right_field: "co.offer_id".into(),
                },
                JoinCondition {
                    left_field: "o.profile".into(),
                    right_field: "co.profile".into(),
                },
            ],
        }],
        projections: vec![],
    ...
    assert_eq!(
        sql_a, sql_b,
        "SQL should be identical for semantically identical plans"
    );
}
